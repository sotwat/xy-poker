...
1. **v12081440** - **Fix: Mobile Dice Sizing (Breakpoint):**
   - **Fix:** consistency: Updated Mobile Breakpoint from 600px to 900px to match App main layout.
   - **Previous:** Fix: Mobile Dice Sizing (Scale - v12081434).
