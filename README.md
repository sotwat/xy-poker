...
1. **v12130856** (2025-12-13): **Fix** - Implemented "Audio Warmup" (unlocks SpeechSynthesis API on mobile during start/interaction) to fix silent voice announcements.
2. **v12130140** (2025-12-13): **Fix** - Fixed persistent "FINISH" text and countdown timer on result screen by stricter phase checking.
