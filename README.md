...
1. **v12130113** (2025-12-13): **Feature** - Added "Auto-Play" button (bottom right) for both Local and Online modes. AI takes over player's turn when active.
2. **v12130053** (2025-12-13): **Fix** - Correctly reset Rematch UI states (modal/waiting message) when a new game starts or when accepted.
