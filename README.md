...
1. **v12130053** (2025-12-13): **Fix** - Correctly reset Rematch UI states (modal/waiting message) when a new game starts or when accepted.
2. **v12130048** (2025-12-13): **Fix** - Fixed issue where online result animation was interrupted for one player due to state synchronization.
